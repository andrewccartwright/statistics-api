package com.andrewchatch.statisticsapi.controllers;
...
import com.andrewchatch.statisticsapi.methods.distributions.Binomial;
import com.andrewchatch.statisticsapi.methods.distributions.Exponential;
import com.andrewchatch.statisticsapi.methods.distributions.Geometric;
import com.andrewchatch.statisticsapi.methods.distributions.Normal;
import com.andrewchatch.statisticsapi.methods.distributions.Poisson;
...
public class DistributionsController {
    ...
    public Map<String,Double> getGeometricProbability(@RequestBody Geometric geo) {
        ...
        Map<String,Double> probsMap = geometric.getProbability(geometric.getX(), geometric.getP());
        return probsMap;
    }
}
